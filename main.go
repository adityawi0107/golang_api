...
func (r *Repository) SetupRoutes(app *fiber.App) {
	...
	api.Get("/orders/:pid", r.GetOrderByID)
}
...
func main() {
	...
	err = models.MigratetOrders(db)
	if err != nil {
		log.Fatal("could not migrate db tOrders")
	}

	err = models.MigratetResults(db)
	if err != nil {
		log.Fatal("could not migrate db tResults")
	}
